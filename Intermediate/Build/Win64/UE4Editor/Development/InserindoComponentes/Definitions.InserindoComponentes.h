#undef INSERINDOCOMPONENTES_API
...
#define UE_PROJECT_NAME InserindoComponentes
#define UE_TARGET_NAME InserindoComponentesEditor
...
#define INSERINDOCOMPONENTES_API DLLEXPORT
